...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game(name="Seu pai é o Marreco, digite {}help".format(config.BOT_PREFIX)))

    for guild in bot.guilds:
        await register(guild)
        print("Entrou na {}".format(guild.name))
